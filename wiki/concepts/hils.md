...
related: ["[[wiki/concepts/sdv]]", "[[wiki/concepts/simulation]]"]
---
...
## 활용 (SDV 시대)
[[wiki/concepts/sdv]] 환경 하에서 CI/CD 파이프라인과 결합하여, 엔지니어 개입 없이 밤낮 24시간 자동으로 수만 가지 테스트 시나리오와 고장 주입(Fault Injection) 테스트를 수행함으로써 소프트웨어의 기능 안전성(ISO 26262) 및 사이버 보안(ISO 21434)을 효율적으로 확보하는 데 핵심 역할을 한다.
