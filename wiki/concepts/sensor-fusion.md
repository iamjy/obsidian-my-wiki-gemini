...
related: ["[[wiki/concepts/perception]]", "[[wiki/concepts/physical-ai]]", "[[wiki/concepts/sensor-architecture]]"]
---
...
* **안전성 강화**: [[wiki/concepts/physical-ai]](자율주행, 휴머노이드 등)가 불규칙한 실제 환경에서 구동될 때 충돌 방지와 즉각적인 판단을 위한 필수 기반 기술이 된다.
